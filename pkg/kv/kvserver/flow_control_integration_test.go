		...
		tc := testcluster.StartTestCluster(t, numNodes, base.TestClusterArgs{
			...
			ServerArgs: base.TestServerArgs{
				...
				RaftConfig: base.RaftConfig{
					...
					//	W230507 19:47:03.186303 4268 github.com/Y77CH/raft/raft.go:924  [T1,n4,s4,r64/4:/{Table/Max-Max}] 354  4 cannot campaign at term 6 since there are still 1 pending configuration changes to apply
					//	...
